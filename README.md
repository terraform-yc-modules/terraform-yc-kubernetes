...
| <a name="provider_yandex"></a> [yandex](#provider\_yandex) | 0.167.0 |
...
| <a name="input_node_security_group_ids_list"></a> [node\_security\_group\_ids\_list](#input\_node\_security\_group\_ids\_list) | List of security group IDs to which the Kubernetes nodes belong | `list(string)` | `[]` | no |
