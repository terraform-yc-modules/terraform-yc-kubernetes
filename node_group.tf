locals {
  ...
  node_group_security_groups_list = concat(var.security_groups_ids_list, var.enable_default_rules == true ? [
    ...
    yandex_vpc_security_group.k8s_main_node_group_sg[0].id
...
resource "yandex_kubernetes_node_group" "kube_node_groups" {
  ...
  instance_template {
    ...
    network_interface {
      ...
      security_group_ids = concat(lookup(each.value, "node_group_security_groups_list", []), local.node_group_security_groups_list)
